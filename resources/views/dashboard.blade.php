        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-4">
                <div class="flex justify-center mt-6">
                    <p class="text-lg lg:text-xl font-semibold">Cupones descargados por franquicia en la historia</p>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-4 items-center justify-items-center gap-4 p-6">
                    <div>
                        <img src="{{ asset('img/logos/burger-logo.svg') }}">
                        <div class="text-lg block lg:hidden text-center mt-4 font-bold">{{ $coupon_bk }} cupones</div>
                    </div>
                    <div>
                        <img src="{{ asset('img/logos/KFC.svg') }}">
                        <div class="text-lg block lg:hidden text-center mt-4 font-bold">{{ $coupon_kfc }} cupones</div>
                    </div>
                    <div>
                        <img src="{{ asset('img/logos/PHUT.svg') }}">
                        <div class="text-lg block lg:hidden text-center mt-4 font-bold">{{ $coupon_ph }} cupones</div>
                    </div>
                    <div>
                        <img src="{{ asset('img/logos/Frame.svg') }}">
                        <div class="text-lg block lg:hidden text-center mt-4 font-bold">{{ $coupon_lbb }} cupones</div>
                    </div>
                </div>
                <div class="lg:grid lg:grid-cols-4 items-center justify-items-center gap-4 p-6 font-bold hidden">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-4">
                <p class="text-center text-sm lg:text-md">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-4">
                <p class="text-center text-sm lg:text-md">
                    ...
                    <span class="lg:mr-2 font-bold block lg:inline-block">{{ $total_clientes }}</span>
                    <span class="lg:ml-4">Total de cupones descargados:</span>
                    <span class="lg:mr-2 font-bold block lg:inline-block">{{ $total_cupones }}</span>
                    <span class="lg:ml-4">Promedio de cupones por cliente:</span>
                    @if ($total_clientes > 0)
                        <span class="mr-2 font-bold block lg:inline-block">{{ number_format($total_cupones / $total_clientes) }}</span>
                    @endif
                </p>
            </div>
